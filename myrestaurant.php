...
<html>
  ...
  <head>
    <title> Manager Login | EatAndMeet </title>
  </head>
...
<div class="container">
    <div class="container">
    	...
    	<div class="list-group">
    		<a href="myrestaurant.php" class="list-group-item active">My Restaurant BRANCH</a>
    ...
    <div class="col-xs-9">
      <div class="form-area" style="padding: 0px 100px 100px 100px;">
        <form action="myrestaurant1.php" method="POST" autocomplete="off">
        <br style="clear: both">
          ...
          <div class="form-group">
          <button type="submit" id="submit" name="submit" class="btn btn-primary pull-right"> ADD RESTAURANT BRANCH </button>    
      </div>
        </form>
