...
<html>
  ...
  <head>
    <title> Contact | EatAndMeet </title>
  </head>
...
?>
    ...
    <div class="heading">
     <strong>Want to contact <span class="edit"> EatAndMeet </span>?</strong>
     <br>
    ...
    <div class="col-md-5" style="float: none; margin: 0 auto;">
      <div class="form-area">
        ...
        <br style="clear: both">
          ...
          <div class="form-group">
            <input type="text" pattern="[789][0-9]{9}" class="form-control" id="mobile" name="mobile" placeholder="Mobile Number" required>
          </div>
