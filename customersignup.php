<html>
<head>
    <title> Guest Signup | EatAndMeet </title>
  </head>
  ...
  <body>
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top navigation-clean-search" role="navigation">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="index.php">EatAndMeet</a>
        </div>
    ...
    <div class="container">
    <div class="jumbotron">
     <h1>Hi Guest, <br> Welcome to <span class="edit"> EatAndMeet </span></h1>
     <br>
   <p>Get started by creating your account</p>
    ...
    <div class="container" style="margin-top: 4%; margin-bottom: 2%;">
      ...
      <div class="panel panel-primary">
        ...
        <form role="form" action="customer_registered_success.php" method="POST" autocomplete="off">
...
return false;
        ...
        <div class="row">
          <div class="form-group col-xs-12">
            ...
            <div class="input-group">
              <input class="form-control" id="contact" type="text" pattern="[789][0-9]{9}" name="contact" placeholder="Contact" required="">
              <span class="input-group-btn">
