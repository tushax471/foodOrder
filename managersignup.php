<html>
  ...
  <head>
    <title> Manager Signup | EatAndMeet </title>
  </head>
  ...
  <body>
    ...
    <div class="container">
    <div class="jumbotron">
     <h1>Hi Manager, <br> Welcome to <span class="edit"> EatAndMeet</span></h1>
     <br>
   <p>Get started by creating your account</p>
    ...
    <div class="container" style="margin-top: 4%; margin-bottom: 2%;">
      ...
      <div class="panel panel-primary">
        ...
        <form role="form" action="manager_registered_success.php" autocomplete="off" method="POST">
